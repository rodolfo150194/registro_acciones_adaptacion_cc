...
var KTAppSidebar = function () {
    ...
    return {
        init: function () {
            var i;
            e = document.querySelector("#kt_app_sidebar_secondary_wrapper"), t = document.querySelector("#kt_app_sidebar_secondary_tags_collapse"), n = document.querySelector('[href="#kt_app_sidebar_secondary_tags_collapse"]'), e && (i = e.querySelector(".menu-link.active")) && !0 !== KTUtil.isVisibleInContainer(i, e) && e.scroll({
                top: KTUtil.getRelativeTopPosition(i, e),
                behavior: "smooth"
            }), t && t.addEventListener("shown.bs.collapse", (t => {
                !0 !== KTUtil.isVisibleInContainer(n, e) && e.scroll({
