...
this.driver.js = function (F) {
    ...
    function K(e) {
        ...
        return e.flatMap(t => {
            const o = t.matches(i), d = Array.from(t.querySelectorAll(i));
            return [...o ? [t] : [], ...d]
    ...
    function Y(e) {
        if (!e || ue(e)) return;
        const i = s("smoothScroll"), t = e.offsetHeight > window.innerHeight;
        e.scrollIntoView({behavior: !i || pe(e) ? "auto" : "smooth", inline: "center", block: t ? "start" : "center"})
    }
    ...
    function fe(e, i, t, o) {
        ...
        const n = d || t.getBoundingClientRect(), f = o.getBoundingClientRect(), w = O(e, n.x, f.x - n.x, i),
            r = O(e, n.y, f.y - n.y, i), v = O(e, n.width, f.width - n.width, i),
            g = O(e, n.height, f.height - n.height, i);
        d = {x: w, y: r, width: v, height: g}, Q(d), k("__activeStagePosition", d)
    }

    function j(e) {
        if (!e) return;
        const i = e.getBoundingClientRect(), t = {x: i.x, y: i.y, width: i.width, height: i.height};
        k("__activeStagePosition", t), Q(t)
    }

    function he() {
        const e = l("__activeStagePosition"), i = l("__overlaySvg");
        if (!e) return;
        if (!i) {
    ...
    function Z(e) {
        const i = window.innerWidth, t = window.innerHeight, o = s("stagePadding") || 0, d = s("stageRadius") || 0,
            n = e.width + o * 2, f = e.height + o * 2, w = Math.min(d, n / 2, f / 2), r = Math.floor(Math.max(w, 0)),
            v = e.x - o + r, g = e.y - o, y = n - r * 2, a = f - r * 2;
    ...
    function be() {
        const e = l("__activeElement"), i = l("__activeStep");
        e && (j(e), he(), ne(e, i))
    }

    function xe(e, i) {
        var C;
        const o = Date.now(), d = l("__activeStep"), n = l("__activeElement") || e, f = !n || n === e,
        ...
        !f && a && a(r ? void 0 : n, d, {config: p, state: c, driver: S()}), g && g(w ? void 0 : e, i, {
            config: p,
            state: c,
            driver: S()
        });
        ...
        const m = () => {
            ...
            const x = Date.now() - o, L = 400 - x <= 400 / 2;
    ...
    function Pe(e) {
        ...
        const o = l("__activeElement"), d = (r = l("popover")) == null ? void 0 : r.wrapper,
            n = K([...d ? [d] : [], ...o ? [o] : []]), f = n[0], w = n[n.length - 1];
    ...
    function ee(e, i) {
        ...
        u.className = `driver-popover ${m}`.trim(), U(t.wrapper, L => {
            var W, I, M;
            const E = L.target, $ = ((W = i.popover) == null ? void 0 : W.onNextClick) || s("onNextClick"),
            ...
            if (E.classList.contains("driver-popover-prev-btn")) return B ? B(e, i, {
                config: s(),
                state: l(),
                driver: S()
            }) : T("prevClick");
    ...
    function te() {
        ...
        const i = e.wrapper.getBoundingClientRect(), t = s("stagePadding") || 0, o = s("popoverOffset") || 0;
        return {width: i.width + t + o, height: i.height + t + o, realWidth: i.width, realHeight: i.height}
    }

    function ie(e, i) {
        const {elementDimensions: t, popoverDimensions: o, popoverPadding: d, popoverArrowDimensions: n} = i;
    ...
    function ne(e, i) {
        const t = l("popover");
        if (!t) return;
        const {align: o = "start", side: d = "left"} = (i == null ? void 0 : i.popover) || {}, n = o,
        ...
        if (f === "top" && a ? b = h = c = !1 : f === "bottom" && c ? b = h = a = !1 : f === "left" && h ? b = a = c = !1 : f === "right" && b && (h = a = c = !1), f === "over") {
            ...
            const x = Math.min(u, window.innerWidth - (r == null ? void 0 : r.realWidth) - v.width),
                P = ie(n, {elementDimensions: g, popoverDimensions: r, popoverPadding: w, popoverArrowDimensions: v});
            ...
            let P = oe(n, {elementDimensions: g, popoverDimensions: r, popoverPadding: w, popoverArrowDimensions: v});
    ...
    function Le(e, i, t) {
        const o = l("popover");
        if (!o) return;
        const d = t.getBoundingClientRect(), n = te(), f = o.arrow, w = n.width, r = window.innerWidth, v = d.width,
            g = d.left, y = n.height, a = window.innerHeight, p = d.top, c = d.height;
        f.className = "driver-popover-arrow";
        let u = i, h = e;
        if (i === "top" ? (g + v <= 0 ? (u = "right", h = "end") : g + v - w <= 0 && (u = "top", h = "start"), g >= r ? (u = "left", h = "end") : g + w >= r && (u = "top", h = "end")) : i === "bottom" ? (g + v <= 0 ? (u = "right", h = "start") : g + v - w <= 0 && (u = "bottom", h = "start"), g >= r ? (u = "left", h = "start") : g + w >= r && (u = "bottom", h = "end")) : i === "left" ? (p + c <= 0 ? (u = "bottom", h = "end") : p + c - y <= 0 && (u = "left", h = "start"), p >= a ? (u = "top", h = "end") : p + y >= a && (u = "left", h = "end")) : i === "right" && (p + c <= 0 ? (u = "bottom", h = "start") : p + c - y <= 0 && (u = "right", h = "start"), p >= a ? (u = "top", h = "start") : p + y >= a && (u = "right", h = "end")), !u) f.classList.add("driver-popover-arrow-none"); else {
    ...
    function Te() {
        ...
        return v.type = "button", v.classList.add("driver-popover-next-btn"), v.innerHTML = "Next &rarr;", w.appendChild(r), w.appendChild(v), n.appendChild(f), n.appendChild(w), e.appendChild(d), e.appendChild(i), e.appendChild(t), e.appendChild(o), e.appendChild(n), {
            wrapper: e,
            arrow: i,
            title: t,
            description: o,
    ...
    function Ae(e = {}) {
        ...
        function g(a = !0) {
            const p = l("__activeElement"), c = l("__activeStep"), u = l("__activeOnDestroyed"),
